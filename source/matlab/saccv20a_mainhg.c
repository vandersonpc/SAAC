...
static mexFunctionTableEntry function_table[8]
  = { { "saccv20a", mlxSaccv20a, 5, 0, &_local_function_table_saccv20a },
...
static _mexInitTermTableEntry init_term_table[9]
  = { { libmmfileInitialize, libmmfileTerminate },
      { InitializeModule_saccv20a, TerminateModule_saccv20a },
...
int main(int argc, const char * * argv) {
    return mclMainhg(argc, argv, mlxSaccv20a, 0, &_main_info);
}
