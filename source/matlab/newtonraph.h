...
#ifndef __newtonraph_h
#define __newtonraph_h 1
...
extern void InitializeModule_newtonraph(void);
extern void TerminateModule_newtonraph(void);
extern _mexLocalFunctionTable _local_function_table_newtonraph;

extern mxArray * mlfNewtonraph(mxArray * * erro,
                               mxArray * * niter,
                               mxArray * Ybus,
                               mxArray * Busnames,
                               mxArray * Busdata);
extern void mlxNewtonraph(int nlhs,
                          mxArray * plhs[],
                          int nrhs,
                          mxArray * prhs[]);
